        ...
        <div className="absolute right-0 top-12 z-[999] w-[360px] overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-[0_18px_60px_rgba(0,0,0,0.18)]">
          ...
          <div className="max-h-[420px] overflow-y-auto">
            {notifications.length === 0 ? (
              ...
              notifications.map((item) => (
                ...
                >
                  <div className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-[#7e4ff5] shadow-sm">
                    {iconFor(item.type)}
                  </div>
          ...
          {notifications.length > 0 && (
            <button
              type="button"
              onClick={markRead}
              className="h-12 w-full border-t border-gray-100 text-sm font-bold text-[#7e4ff5] hover:bg-gray-50"
            >
              Mark all as read
            </button>
          )}
