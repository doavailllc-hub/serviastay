...
function DocumentBox({ title, url }) {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-[#FAFAFC] p-5">
      <div className="mb-4 flex items-center gap-2 text-[#7e4ff5]">
        <FileText size={18} />
      ...
      {!url ? (
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-xl bg-[#7e4ff5] px-4 py-2 text-sm font-bold text-white hover:bg-[#6f43e4]"
        >
          <Eye size={16} />
          View PDF
        </a>
