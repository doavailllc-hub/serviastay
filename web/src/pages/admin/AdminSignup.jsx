      ...
      <div className="flex min-h-screen items-center justify-center px-5 py-10">
        <div className="w-full max-w-lg">
          <div className="mb-8 text-center">
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#8363F5]">
              <ShieldCheck size={30} />
            </div>
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="h-14 w-full rounded-xl bg-[#8363F5] text-lg font-bold text-white shadow-lg transition hover:bg-[#7152E8] disabled:opacity-60"
              >
            ...
            <button
              ...
              className="mt-6 w-full text-sm font-semibold text-[#8363F5]"
            >
