      ...
      <div className="flex flex-col gap-5 md:flex-row">
        ...
        <div className="flex-1">
          <div className="flex flex-col justify-between gap-3 md:flex-row md:items-start">
            ...
            <div className="rounded-full bg-[#F4F1FF] px-4 py-2 font-semibold text-[#7e4ff5]">
              ⭐ {review.rating}
            </div>
          </div>

          <div className="mt-4 flex text-[#7e4ff5]">
            {[1, 2, 3, 4, 5].map((star) => (
              <Star
                key={star}
                size={17}
          ...
          {review.host_reply ? (
            <div className="mt-5 rounded-2xl border border-[#e8e2ff] bg-[#f7f4ff] p-4">
              <div className="mb-2 flex items-center gap-2 font-bold text-[#7e4ff5]">
            ...
            <div className="mt-5 rounded-2xl border border-gray-200 bg-white p-4">
              ...
              <textarea
                ...
                className="mt-3 w-full resize-none rounded-xl border border-gray-300 p-3 text-sm outline-none focus:border-[#7e4ff5] focus:ring-2 focus:ring-[#7e4ff5]/20"
              />
              ...
              <button
                ...
                onClick={onReply}
                disabled={replying}
                className="mt-3 inline-flex items-center gap-2 rounded-xl bg-[#7e4ff5] px-5 py-2.5 font-bold text-white transition hover:bg-[#6f43e4] disabled:cursor-not-allowed disabled:opacity-60"
              >
                <Send size={16} />
