      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="relative max-w-3xl mb-10">
          ...
          <input
            ...
            className="w-full h-16 pl-14 pr-5 rounded-2xl border border-gray-300 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#8363F5] focus:border-[#8363F5]"
          />
        </div>
        ...
        <div className="mt-10 bg-white rounded-3xl border border-gray-100 shadow-sm p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <button className="px-8 h-14 rounded-xl bg-[#8363F5] hover:bg-[#7152E8] text-white font-semibold transition shadow-lg">
            Contact Support
          </button>
        </div>
      </main>
