        ...
        <div className="mb-8 flex flex-col gap-5 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <span className="mt-2 inline-flex rounded-full bg-[#F4F1FF] px-3 py-1 text-xs font-bold capitalize text-[#8363F5]">
                {user?.role || "guest"}
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="rounded-xl bg-[#8363F5] px-6 py-3 font-semibold text-white transition hover:bg-[#7152E8]"
          >
            Edit Profile
          </button>
        </div>
          ...
          <div className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <button
                onClick={saveProfile}
                disabled={saving}
                className="h-14 flex-1 rounded-xl bg-[#8363F5] font-semibold text-white hover:bg-[#7152E8] disabled:opacity-60"
              >
