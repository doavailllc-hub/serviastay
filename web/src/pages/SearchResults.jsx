        ...
        <section className="px-4 pb-5">
          <div className="relative mx-auto flex h-[66px] max-w-5xl items-center rounded-full border border-gray-200 bg-white shadow-[0_3px_18px_rgba(0,0,0,0.08)]">
            ...
            <button
              ...
              className="mr-2 flex h-11 w-11 items-center justify-center rounded-full bg-[#8363F5] text-white"
            >
              ...
              <Dropdown left="right-[70px]" width="w-[380px]">
                ...
                <div className="mt-5 flex justify-end">
                  <button
                    ...
                    className="rounded-xl bg-[#8363F5] px-5 py-2 font-semibold text-white"
                  >
                    Done
                  </button>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex justify-between pt-4">
                    ...
                    <button
                      ...
                      className="rounded-xl bg-[#8363F5] px-6 py-3 font-semibold text-white"
                    >
                      Show results
                    </button>
                  </div>
...
function FilterChip({ text, clear }) {
  return (
    <button
      onClick={clear}
      className="rounded-full bg-[#F4F1FF] px-4 py-2 text-sm font-semibold text-[#8363F5]"
    >
      {text} ×
    </button>
  );
