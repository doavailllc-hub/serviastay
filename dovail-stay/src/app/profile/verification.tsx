...
function DocumentPicker({ title, document, onPress }: { title: string; document: PickedDocument | null; onPress: () => void }) {
  return <Pressable style={styles.card} onPress={onPress}>{document ? <Image source={{ uri: document.uri }} style={styles.preview} /> : <View style={styles.fileIcon}><FileImage size={24} color="#2DB281" /></View>}<View style={{ flex: 1 }}><Text style={styles.cardTitle}>{title}</Text><Text numberOfLines={1} style={styles.cardText}>{document?.name || "Tap to select an image"}</Text></View></Pressable>;
}

const styles = StyleSheet.create({
  safe:{flex:1,backgroundColor:"#f7f8fa"},header:{height:64,paddingHorizontal:18,backgroundColor:"#fff",flexDirection:"row",alignItems:"center",justifyContent:"space-between",borderBottomWidth:1,borderBottomColor:"#e5e7eb"},headerTitle:{fontFamily:"PlusJakartaSans_700Bold",fontSize:18,color:"#172033"},content:{padding:20,gap:16},hero:{backgroundColor:"#fff",borderRadius:24,padding:24,alignItems:"center",gap:11},title:{fontFamily:"PlusJakartaSans_700Bold",fontSize:22,color:"#172033",textAlign:"center"},body:{fontFamily:"Inter_400Regular",fontSize:14,lineHeight:21,color:"#687386",textAlign:"center"},badge:{backgroundColor:"#E8F7F1",paddingHorizontal:12,paddingVertical:6,borderRadius:99},badgeText:{fontFamily:"Inter_600SemiBold",fontSize:12,color:"#21845F"},rejection:{fontFamily:"Inter_500Medium",fontSize:13,color:"#b42318",textAlign:"center"},card:{backgroundColor:"#fff",borderRadius:18,padding:14,flexDirection:"row",alignItems:"center",gap:13},fileIcon:{width:54,height:54,borderRadius:14,backgroundColor:"#E8F7F1",alignItems:"center",justifyContent:"center"},preview:{width:54,height:54,borderRadius:14},cardTitle:{fontFamily:"Inter_600SemiBold",fontSize:15,color:"#172033"},cardText:{fontFamily:"Inter_400Regular",fontSize:12,color:"#687386",marginTop:4},button:{height:54,borderRadius:16,backgroundColor:"#2DB281",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:9},disabled:{opacity:.45},buttonText:{fontFamily:"Inter_600SemiBold",fontSize:14,color:"#fff"},note:{fontFamily:"Inter_400Regular",fontSize:12,lineHeight:18,color:"#687386",textAlign:"center"}
});
